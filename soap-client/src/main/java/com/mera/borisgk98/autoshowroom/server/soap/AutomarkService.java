 ...
 * 2019-06-03T11:44:07.718+03:00
 * Generated source version: 3.3.1
 *
 */
@WebServiceClient(name = "automarkService",
                  wsdlLocation = "http://35.228.60.112/services/automark?wsdl",
                  targetNamespace = "http://soap.server.autoshowroom.borisgk98.mera.com/")
@Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-06-03T11:44:07.718+03:00", comments = "Apache CXF 3.3.1")
public class AutomarkService extends Service {

    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-06-03T11:44:07.718+03:00")
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://35.228.60.112/services/automark?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AutomarkService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://35.228.60.112/services/automark?wsdl");
        }
        WSDL_LOCATION = url;
    }
