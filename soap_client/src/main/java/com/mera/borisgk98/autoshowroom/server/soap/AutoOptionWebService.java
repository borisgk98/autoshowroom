 ...
 * 2019-05-24T00:38:51.781+03:00
 * Generated source version: 3.3.1
 *
 */
@WebService(targetNamespace = "http://soap.server.autoshowroom.borisgk98.mera.com/", name = "AutoOptionWebService")
@XmlSeeAlso({ObjectFactory.class})
@Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-05-24T00:38:51.781+03:00", comments = "Apache CXF 3.3.1")
public interface AutoOptionWebService {
    ...
    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-05-24T00:38:51.781+03:00")
    public java.util.List<com.mera.borisgk98.autoshowroom.server.soap.AutoOption> getRange(
    ...
    @WebResult(name = "return", targetNamespace = "")
    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-05-24T00:38:51.781+03:00")
    public java.util.List<com.mera.borisgk98.autoshowroom.server.soap.AutoOption> getAll();
    ...
    @WebResult(name = "return", targetNamespace = "")
    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-05-24T00:38:51.781+03:00")
    public com.mera.borisgk98.autoshowroom.server.soap.AutoOption read(
        @WebParam(name = "arg0", targetNamespace = "")
        java.lang.Integer arg0
    ...
    @WebResult(name = "return", targetNamespace = "")
    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-05-24T00:38:51.781+03:00")
    public com.mera.borisgk98.autoshowroom.server.soap.AutoOption create(
        @WebParam(name = "arg0", targetNamespace = "")
    ...
    @WebResult(name = "return", targetNamespace = "")
    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-05-24T00:38:51.781+03:00")
    public com.mera.borisgk98.autoshowroom.server.soap.AutoOption update(
        @WebParam(name = "arg0", targetNamespace = "")
        com.mera.borisgk98.autoshowroom.server.soap.AutoOption arg0
    ) throws ModelNotFound_Exception;
}
