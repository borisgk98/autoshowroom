...
/**
 * <p>Java class for getRangeOrderResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="getRangeOrderResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getRangeOrderResponse", propOrder = {
    "_return"
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2019-05-24T02:14:59+03:00", comments = "JAXB RI v2.3.2")
public class GetRangeOrderResponse implements Equals2, HashCode2
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-05-24T02:14:59+03:00", comments = "JAXB RI v2.3.2")
    public GetRangeOrderResponse withReturn(Order... values) {
        if (values!= null) {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-05-24T02:14:59+03:00", comments = "JAXB RI v2.3.2")
    public GetRangeOrderResponse withReturn(Collection<Order> values) {
        if (values!= null) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GetRangeOrderResponse that = ((GetRangeOrderResponse) object);
        {
