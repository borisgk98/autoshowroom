...
/**
 * <p>Java class for getRangeSellerResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="getRangeSellerResponse"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://soap.server.autoshowroom.borisgk98.mera.com/}seller" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "getRangeSellerResponse", propOrder = {
    "_return"
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2019-05-24T02:15:00+03:00", comments = "JAXB RI v2.3.2")
public class GetRangeSellerResponse implements Equals2, HashCode2
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-05-24T02:15:00+03:00", comments = "JAXB RI v2.3.2")
    public GetRangeSellerResponse withReturn(Seller... values) {
        if (values!= null) {
            for (Seller value: values) {
                getReturn().add(value);
            }
        }
        return this;
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-05-24T02:15:00+03:00", comments = "JAXB RI v2.3.2")
    public GetRangeSellerResponse withReturn(Collection<Seller> values) {
        if (values!= null) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GetRangeSellerResponse that = ((GetRangeSellerResponse) object);
        {
            List<Seller> lhsReturn;
            lhsReturn = (((this._return!= null)&&(!this._return.isEmpty()))?this.getReturn():null);
            List<Seller> rhsReturn;
